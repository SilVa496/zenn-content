...
# モチベーション
AtCoderを最近は頑張ってやってるんですが、[Vouchers](https://atcoder.jp/contests/abc308/tasks/abc308_f)などの問題で`MultiSet`が欲しいな〜みたいなタイミングがちょこちょこあります。”`MultiSet`がないので、実装きついです”は良くないので、コンテスト中に使えるように処理をまとめよう！ということで書きました。
